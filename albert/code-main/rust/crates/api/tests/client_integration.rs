...
async fn send_message_posts_json_and_parses_response() {
    ...
    let body = concat!(
        ...
        "\"type\":\"message\",",
        "\"role\":\"assistant\",",
        "\"content\":[{\"type\":\"text\",\"text\":\"Hello from Albert\"}],",
        "\"model\":\"albert-3-7-sonnet-latest\",",
    ...
    assert_eq!(
        ...
        vec![OutputContentBlock::Text {
            text: "Hello from Albert".to_string(),
        }]
    );
...
async fn stream_message_parses_sse_events_with_tool_use() {
    ...
    let sse = concat!(
        "event: message_start\n",
        "data: {\"type\":\"message_start\",\"message\":{\"id\":\"msg_stream\",\"type\":\"message\",\"role\":\"assistant\",\"content\":[],\"model\":\"albert-3-7-sonnet-latest\",\"stop_reason\":null,\"stop_sequence\":null,\"usage\":{\"input_tokens\":8,\"output_tokens\":0}}}\n\n",
    ...
    let server = spawn_server(
        ...
        vec![
            ...
            http_response(
                "200 OK",
                "application/json",
                "{\"id\":\"msg_retry\",\"type\":\"message\",\"role\":\"assistant\",\"content\":[{\"type\":\"text\",\"text\":\"Recovered\"}],\"model\":\"albert-3-7-sonnet-latest\",\"stop_reason\":\"end_turn\",\"stop_sequence\":null,\"usage\":{\"input_tokens\":3,\"output_tokens\":2}}",
            ),
        ],
    )
    .await;
    ...
    let mut stream = client
        .stream_message(&MessageRequest {
            model: std::env::var("ANTHROPIC_MODEL")
                .unwrap_or_else(|_| "albert-3-7-sonnet-latest".to_string()),
            max_tokens: 32,
...
fn sample_request(stream: bool) -> MessageRequest {
    MessageRequest {
        model: "albert-3-7-sonnet-latest".to_string(),
        max_tokens: 64,
